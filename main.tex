...
\section{Leadership / Extracurricular / Contributions}
            \resumeItemListStart
                ...
                % \vspace{-7pt}
                \resumeItem{\href{https://yakkshit.com}{I have contributed to adding a new class, MicroK8sClusterUpgradeEvent, to the Micro K8 Cluster and implemented upgrade logic to handle it for performing necessary upgrade logic for the Micro K8s cluster.}}
