...
I am a \textbf{Software Developer} with a passion for building high-quality software. I have experience in Full-stack Development and have contributed to the product lifecycle, from requirements analysis to deployment. I have a strong understanding of authentication and authorization, and I effectively manage Automation, networking and logs using tools such as Bash Scripting in linux, 
Kubernetes, Docker, Ansible, 
AWS CLI. 
I have hands-on experience with CI/CD, DevOps, infrastructure as code, and GitHub Version Control. I have extensive experience in implementing professional practices such as Agile methodologies. In recent Times I have also Contributed to Micro K8s clusters and Kubernetes.}
...
% -----------------------------------------------------------------------------
 ...
 % \resumeProjectHeading
 %          {\textbf{\href{https://github.com/yakkshit/2048-3d-master.git}{2048 3d game}} $|$ \emph{CI/CD, Unity}}{March 2023}\\
 %          \vspace{9pt}
 %          \vspace{-8pt}
 %          \resumeItemListStart
