...
I am a \textbf{Software Developer} with a passion for building high-quality software. I have experience in  Software Development and have contributed to the product lifecycle, from requirements analysis to deployment. I have a strong understanding of authentication and authorization, and I effectively manage automation, networking, and logs using tools such as Bash Scripting in Linux, 
Python programming,
AWS CLI. 
...
\section{\href{https://www.linkedin.com/in/yakkshit/details/skills/}{Technical Skills} \faLink}
 \begin{itemize}[leftmargin=0.15in, label={}]
    \small{\item{
     \textbf{Deployment/Automation/templating tools - }{ Docker, Bitbucket/Gitlab.} \\
     \textbf{Frameworks - }{Django, TensorFlow, Flutter, React.}\\
     \textbf{Languages - }{ Python, Java, HTML, CSS, JS, PHP, SQL, TypeScript.}\\
    }}
 \end{itemize}
%-----------EXPERIENCE-----------
\section{\href{https://www.linkedin.com/in/yakkshit/}{Professional Experience  \faLink}}
  ...
  \resumeSubheading
    ...
    \resumeItemListEnd
    \vspace{-3pt}
    \textbf{Environment:}\emph{Bug reporting, Code Review, debugging, problem-solving, collaboration, Appium.}

    \resumeSubheading
      {CEDZLABS}{May 2021 -- Dec 2022}
...
%           \vspace{-5pt}
%           \resumeItemListStart
%             \resumeItem{Utilized Cloud Source Repositories, Kubernetes Engine, Load Balancers, and troubleshooting workloads on GKE to improve DevOps practices in GCP. Created Kubernetes clusters and used Docker for containerization for cloud repositories with Git for version control. Managed deployments using Kubernetes Engine, scaling and managing containers for common scenarios. Deployed Kubernetes Load Balancer Service with Terraform, setting up a Kubernetes cluster and deploying Nginx service on it. Deployed using continuous integration and configured a continuous delivery pipeline using Jenkins on Kubernetes Engine.}
