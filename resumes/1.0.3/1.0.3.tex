...
Dynamic Fullstack Developer with a strong foundation in creating innovative recommender systems and enhancing digital media experiences. Proficient in JavaScript/TypeScript, React, and cloud technologies. Passionate about machine learning and collaborative development in agile environments.

\section{Technical Skills \faLink}
\begin{itemize}[leftmargin=0.15in, label={}]
\small{\item{
\textbf{Frameworks - }{React, Vue.js, Figma, Sketch.} \\
\textbf{Languages - }{JavaScript (ES6+), TypeScript, HTML5, CSS3, Python, Golang.} \\
\textbf{Tools - }{Git, Postman, Swagger, RESTful APIs, GraphQL.} \\
\textbf{Deployment - }{AWS, Docker, GitHub Actions.}\\
}}
\end{itemize}
\vspace{-10pt}
...
\resumeItemListStart
\vspace{-10pt}
\resumeItem{Developing a recommender system for news websites and apps using React and Node.js, enhancing user engagement through personalized content.}
\resumeItem{Collaborating with data scientists to implement machine learning algorithms for content recommendation and user behavior analysis.}
\resumeItem{Embracing agile practices with pair programming, code reviews, and continuous deployment methodologies.}
\resumeItemListEnd
\vspace{-3pt}
\textbf{Environment:}\emph{JavaScript, React, Node.js, AWS, GitHub Actions, Agile methodologies.}

\resumeSubheading
{Netnedge \faBuilding}{Juuly 2023 -- January 2024}
{Full Stack Engineer(Frontend Focus)}{\faMapMarker \hspace{0.1cm} Stockholm, Sweden}\\
\vspace{10pt}
\textbf{Responsibilities:}
\resumeItemListStart
\vspace{-10pt}
