...
Dynamic Full Stack Engineer with a strong focus on frontend technologies and UI/UX design. Extensive experience in developing responsive applications, especially in AI-powered environments. Passionate about creating seamless digital experiences and integrating cutting-edge technologies.}

%-----------PROGRAMMING SKILLS-----------
\section{\href{https://www.linkedin.com/in/yakkshit/details/skills/}{Technical Skills} \faLink}
\begin{itemize}[leftmargin=0.15in, label={}]
\small{\item{
\textbf{Frameworks - }{React, Next.js, Meteor, Vue.js, Figma, Sketch.} \\
...
{\large Spoki \faBuilding}{}
  {Full Stack Engineer}{\faMapMarker \hspace{0.1cm}  Italy}\\
\vspace{10pt}
\textbf{Responsibilities:}
\resumeItemListStart
\vspace{-10pt}
\resumeItem{Translate design mockups into responsive web pages using React and Next.js, focusing on delivering a seamless user experience.}
\resumeItem{Collaborate with backend teams to integrate RESTful APIs, ensuring data flow and functionality.}
\resumeItem{Implement best practices for code maintainability and performance optimization in an Agile environment.}
\resumeItemListEnd
\vspace{-3pt}
\textbf{Environment:}\emph{React, Next.js, JavaScript, RESTful APIs, Agile methodologies.}
