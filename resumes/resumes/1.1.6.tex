...
Detail-oriented Software Engineering student with a strong foundation in software testing, debugging, and documentation. Passionate about mobile application development, particularly in Flutter and embedded systems. Eager to contribute to innovative solutions in the tech industry while maintaining high standards of quality assurance.}
...
\textbf{Languages - }{JavaScript (ES6+), HTML5, CSS3, Python, Dart.} \\
\textbf{Tools - }{Git, Postman, Swagger, RESTful APIs, JIRA.} \\
...
{\textbf{\href{https://ui.cedzlabs.com/resume}{Smart Baby Monitor App}} $|$ \emph{Flutter, Firebase}}{August 2024 $|$ \faBuilding \hspace{0.1cm}Cedzlabs}\\
\vspace{6pt}
\textbf{Description:}
\vspace{-5pt}
\resumeItemListStart
\resumeItem{Developed a Smart Baby Monitor application using Flutter that allows parents to track their baby's wellbeing through real-time monitoring and notifications. Implemented a robust testing strategy to ensure app functionality and user experience across multiple devices. Utilized Firebase for backend integration and user authentication, emphasizing high-quality documentation for compliance with testing standards.}
\resumeItemListEnd
\vspace{4pt}
\textbf{Tools:}\emph{
Flutter, Firebase, Dart, Git.}
\vspace{-10pt}
...
\resumeItem{Active participant in tech meetups and workshops, focusing on software testing and UI/UX best practices.}
\resumeItemListEnd
